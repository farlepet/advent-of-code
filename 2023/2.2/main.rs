...
fn min_game(game: &Game) -> Cubes {
    let mut max = Cubes {
        red:   game.pulls[0].red,
        green: game.pulls[0].green,
        blue:  game.pulls[0].blue
    };
    /* Repeating the first index, because lazy */
